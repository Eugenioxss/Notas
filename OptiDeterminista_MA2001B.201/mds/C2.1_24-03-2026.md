...
$$
\nabla Ec_1 = \begin{bmatrix} \frac{\partial}{\partial x_1}(-x_1 -2x_2) \\\\ \frac{\partial}{\partial x_2}(-x_1-2x_2) \end{bmatrix} = \begin{bmatrix} -1 \\\\ -2 \end{bmatrix}
$$
...
$$
\nabla Ec_2 = \begin{bmatrix} 1 \\\\ 1 \end{bmatrix}
$$   
...
La solución óptima $z^\ast=12$ se obtiene por la combinación $(x_1^\ast,x_2^\ast)=(6,0)$
...
Solución óptima finita múltiple. Los dos vertices $x_1^\ast$ y $x_2^\ast$ son óptimos, así como cualquier punto sobre el segmento de recta que los une. Cualquier punto sobre el rayo con vértice $z^\ast$ es óptimo.

Sección óptima no acotada o ilimitada. La región factible y la solución óptima no están acotadas. Para un problema de minimización, el plano $cx=z$ se puede mover indefinidamente en dirección de -c, intersecando siempre en la región factible. El objetivo óptimo es no acotado con valor de $-\infty$
